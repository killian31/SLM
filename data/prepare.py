...
def prepare_data(textfile):
    ...
    train_ids.tofile(os.path.join(os.path.dirname(__file__), "data/family/train.bin"))
    val_ids.tofile(os.path.join(os.path.dirname(__file__), "data/family/val.bin"))
    ...
    with open(
        os.path.join(os.path.dirname(__file__), "data/family/meta.pkl"), "wb"
    ) as f:
        pickle.dump(meta, f)
